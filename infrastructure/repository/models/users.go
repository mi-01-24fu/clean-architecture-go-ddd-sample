...
type User struct {
	...
	Mailaddress  string    `boil:"mailaddress" json:"mailaddress" toml:"mailaddress" yaml:"mailaddress"`
...
var UserWhere = struct {
	...
	Mailaddress:  whereHelperstring{field: "\"users\".\"mailaddress\""},
...
var (
	userAllColumns            = []string{"id", "username", "mailaddress", "password_hash", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "mailaddress", "password_hash"}
...
func (userL) LoadTasks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`tasks`),
		qm.WhereIn(`tasks.users_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddTasksG(ctx context.Context, insert bool, related ...*Task) error {
...
// Sets related.R.User appropriately.
// Panics on error.
func (o *User) AddTasksP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Task) {
	if err := o.AddTasks(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
func (o *User) AddTasksGP(ctx context.Context, insert bool, related ...*Task) {
	if err := o.AddTasks(ctx, boil.GetContextDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// SetTasksG removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's Tasks accordingly.
// Replaces o.R.Tasks with related.
// Sets related.R.User's Tasks accordingly.
// Uses the global database handle.
func (o *User) SetTasksG(ctx context.Context, insert bool, related ...*Task) error {
	return o.SetTasks(ctx, boil.GetContextDB(), insert, related...)
}

// SetTasksP removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's Tasks accordingly.
// Replaces o.R.Tasks with related.
// Sets related.R.User's Tasks accordingly.
// Panics on error.
func (o *User) SetTasksP(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Task) {
	if err := o.SetTasks(ctx, exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetTasksGP removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's Tasks accordingly.
// Replaces o.R.Tasks with related.
// Sets related.R.User's Tasks accordingly.
// Uses the global database handle and panics on error.
func (o *User) SetTasksGP(ctx context.Context, insert bool, related ...*Task) {
	if err := o.SetTasks(ctx, boil.GetContextDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Replaces o.R.Tasks with related.
// Sets related.R.User's Tasks accordingly.
func (o *User) SetTasks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Task) error {
	query := "update \"tasks\" set \"users_id\" = null where \"users_id\" = $1"
...
// RemoveTasksG relationships from objects passed in.
// Removes related items from R.Tasks (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
// Uses the global database handle.
func (o *User) RemoveTasksG(ctx context.Context, related ...*Task) error {
	return o.RemoveTasks(ctx, boil.GetContextDB(), related...)
}

// RemoveTasksP relationships from objects passed in.
// Removes related items from R.Tasks (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
// Panics on error.
func (o *User) RemoveTasksP(ctx context.Context, exec boil.ContextExecutor, related ...*Task) {
	if err := o.RemoveTasks(ctx, exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveTasksGP relationships from objects passed in.
// Removes related items from R.Tasks (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
// Uses the global database handle and panics on error.
func (o *User) RemoveTasksGP(ctx context.Context, related ...*Task) {
	if err := o.RemoveTasks(ctx, boil.GetContextDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Removes related items from R.Tasks (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
func (o *User) RemoveTasks(ctx context.Context, exec boil.ContextExecutor, related ...*Task) error {
	if len(related) == 0 {
		return nil
	}
